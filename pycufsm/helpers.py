...
def lengths_recommend(
    ...
    Args:
        ...
        length_append (Optional[float], optional): Any additional specific length to include in the half-wavelengths. Defaults to None.
...
def m_recommend(
    ...
    Args:
        ...
        elements (np.ndarray): standard parameter
        sect_props (Sect_Props): section properties
        length_append (Optional[float], optional): any additional half-wavelength to include. Defaults to None.
        n_lengths (int, optional): number of half-wavelengths. Defaults to 50.
        lengths (Optional[np.ndarray], optional): specific half-wavelengths to use. Defaults to None.
...
def load_mat(mat: Cufsm_MAT_File) -> PyCufsm_Input:
    ...
    Args:
        mat (Cufsm_MAT_File): dicionary of data read from a MAT file (as generated by scipy.io.loadmat())
